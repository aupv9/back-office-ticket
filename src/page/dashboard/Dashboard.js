...
import {RevenueMethod} from "./RevenueMethod";
...

            {
                ...
                <div style={styles.flex}>
                    <div style={styles.leftCol}>
                        ...
                        <div style={styles.singleCol}>
                            {
                                isHavePermission("READ_CHART_MANAGER") && <RevenueMethod  role={3}/>
                            }
                            {
                                isHavePermission("READ_CHART_SENIOR_MANAGER") && <RevenueMethod  role={1}/>
                            }
                        </div>
